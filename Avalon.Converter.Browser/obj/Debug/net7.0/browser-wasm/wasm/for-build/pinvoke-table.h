...
int hb_blob_copy_writable_or_fail (int);
int hb_blob_create (int,int,int,int,int);
int hb_blob_create_from_file (int);
int hb_blob_create_from_file_or_fail (int);
int hb_blob_create_or_fail (int,int,int,int,int);
int hb_blob_create_sub_blob (int,int,int);
void hb_blob_destroy (int);
int hb_blob_get_data (int,int);
int hb_blob_get_data_writable (int,int);
int hb_blob_get_empty ();
int hb_blob_get_length (int);
int hb_blob_is_immutable (int);
void hb_blob_make_immutable (int);
int hb_blob_reference (int);
void hb_buffer_add (int,int,int);
void hb_buffer_add_codepoints (int,int,int,int,int);
void hb_buffer_add_latin1 (int,int,int,int,int);
void hb_buffer_add_utf16 (int,int,int,int,int);
void hb_buffer_add_utf32 (int,int,int,int,int);
void hb_buffer_add_utf8 (int,int,int,int,int);
int hb_buffer_allocation_successful (int);
void hb_buffer_append (int,int,int,int);
void hb_buffer_clear_contents (int);
int hb_buffer_create ();
int hb_buffer_deserialize_glyphs (int,int,int,int,int,int);
int hb_buffer_deserialize_unicode (int,int,int,int,int);
void hb_buffer_destroy (int);
int hb_buffer_diff (int,int,int,int);
int hb_buffer_get_cluster_level (int);
int hb_buffer_get_content_type (int);
int hb_buffer_get_direction (int);
int hb_buffer_get_empty ();
int hb_buffer_get_flags (int);
int hb_buffer_get_glyph_infos (int,int);
int hb_buffer_get_glyph_positions (int,int);
int hb_buffer_get_invisible_glyph (int);
int hb_buffer_get_language (int);
int hb_buffer_get_length (int);
int hb_buffer_get_replacement_codepoint (int);
int hb_buffer_get_script (int);
int hb_buffer_get_unicode_funcs (int);
void hb_buffer_guess_segment_properties (int);
int hb_buffer_has_positions (int);
void hb_buffer_normalize_glyphs (int);
int hb_buffer_pre_allocate (int,int);
int hb_buffer_reference (int);
void hb_buffer_reset (int);
void hb_buffer_reverse (int);
void hb_buffer_reverse_clusters (int);
void hb_buffer_reverse_range (int,int,int);
int hb_buffer_serialize (int,int,int,int,int,int,int,int,int);
int hb_buffer_serialize_format_from_string (int,int);
int hb_buffer_serialize_format_to_string (int);
int hb_buffer_serialize_glyphs (int,int,int,int,int,int,int,int,int);
int hb_buffer_serialize_list_formats ();
int hb_buffer_serialize_unicode (int,int,int,int,int,int,int,int);
void hb_buffer_set_cluster_level (int,int);
void hb_buffer_set_content_type (int,int);
void hb_buffer_set_direction (int,int);
void hb_buffer_set_flags (int,int);
void hb_buffer_set_invisible_glyph (int,int);
void hb_buffer_set_language (int,int);
int hb_buffer_set_length (int,int);
void hb_buffer_set_message_func (int,int,int,int);
void hb_buffer_set_replacement_codepoint (int,int);
void hb_buffer_set_script (int,int);
void hb_buffer_set_unicode_funcs (int,int);
int hb_color_get_alpha (int);
int hb_color_get_blue (int);
int hb_color_get_green (int);
int hb_color_get_red (int);
int hb_direction_from_string (int,int);
int hb_direction_to_string (int);
int hb_face_builder_add_table (int,int,int);
int hb_face_builder_create ();
void hb_face_collect_unicodes (int,int);
void hb_face_collect_variation_selectors (int,int);
void hb_face_collect_variation_unicodes (int,int,int);
int hb_face_count (int);
int hb_face_create (int,int);
int hb_face_create_for_tables (int,int,int);
void hb_face_destroy (int);
int hb_face_get_empty ();
int hb_face_get_glyph_count (int);
int hb_face_get_index (int);
int hb_face_get_table_tags (int,int,int,int);
int hb_face_get_upem (int);
int hb_face_is_immutable (int);
void hb_face_make_immutable (int);
int hb_face_reference (int);
int hb_face_reference_blob (int);
int hb_face_reference_table (int,int);
void hb_face_set_glyph_count (int,int);
void hb_face_set_index (int,int);
void hb_face_set_upem (int,int);
int hb_feature_from_string (int,int,int);
void hb_feature_to_string (int,int,int);
void hb_font_add_glyph_origin_for_direction (int,int,int,int,int);
int hb_font_create (int);
int hb_font_create_sub_font (int);
void hb_font_destroy (int);
int hb_font_funcs_create ();
void hb_font_funcs_destroy (int);
int hb_font_funcs_get_empty ();
int hb_font_funcs_is_immutable (int);
void hb_font_funcs_make_immutable (int);
int hb_font_funcs_reference (int);
void hb_font_funcs_set_font_h_extents_func (int,int,int,int);
void hb_font_funcs_set_font_v_extents_func (int,int,int,int);
void hb_font_funcs_set_glyph_contour_point_func (int,int,int,int);
void hb_font_funcs_set_glyph_extents_func (int,int,int,int);
void hb_font_funcs_set_glyph_from_name_func (int,int,int,int);
void hb_font_funcs_set_glyph_h_advance_func (int,int,int,int);
void hb_font_funcs_set_glyph_h_advances_func (int,int,int,int);
void hb_font_funcs_set_glyph_h_kerning_func (int,int,int,int);
void hb_font_funcs_set_glyph_h_origin_func (int,int,int,int);
void hb_font_funcs_set_glyph_name_func (int,int,int,int);
void hb_font_funcs_set_glyph_v_advance_func (int,int,int,int);
void hb_font_funcs_set_glyph_v_advances_func (int,int,int,int);
void hb_font_funcs_set_glyph_v_origin_func (int,int,int,int);
void hb_font_funcs_set_nominal_glyph_func (int,int,int,int);
void hb_font_funcs_set_nominal_glyphs_func (int,int,int,int);
void hb_font_funcs_set_variation_glyph_func (int,int,int,int);
int hb_font_get_empty ();
void hb_font_get_extents_for_direction (int,int,int);
int hb_font_get_face (int);
int hb_font_get_glyph (int,int,int,int);
void hb_font_get_glyph_advance_for_direction (int,int,int,int,int);
void hb_font_get_glyph_advances_for_direction (int,int,int,int,int,int,int);
int hb_font_get_glyph_contour_point (int,int,int,int,int);
int hb_font_get_glyph_contour_point_for_origin (int,int,int,int,int,int);
int hb_font_get_glyph_extents (int,int,int);
int hb_font_get_glyph_extents_for_origin (int,int,int,int);
int hb_font_get_glyph_from_name (int,int,int,int);
int hb_font_get_glyph_h_advance (int,int);
void hb_font_get_glyph_h_advances (int,int,int,int,int,int);
int hb_font_get_glyph_h_kerning (int,int,int);
int hb_font_get_glyph_h_origin (int,int,int,int);
void hb_font_get_glyph_kerning_for_direction (int,int,int,int,int,int);
int hb_font_get_glyph_name (int,int,int,int);
void hb_font_get_glyph_origin_for_direction (int,int,int,int,int);
int hb_font_get_glyph_v_advance (int,int);
void hb_font_get_glyph_v_advances (int,int,int,int,int,int);
int hb_font_get_glyph_v_origin (int,int,int,int);
int hb_font_get_h_extents (int,int);
int hb_font_get_nominal_glyph (int,int,int);
int hb_font_get_nominal_glyphs (int,int,int,int,int,int);
int hb_font_get_parent (int);
void hb_font_get_ppem (int,int,int);
float hb_font_get_ptem (int);
void hb_font_get_scale (int,int,int);
int hb_font_get_v_extents (int,int);
int hb_font_get_var_coords_normalized (int,int);
int hb_font_get_variation_glyph (int,int,int,int);
int hb_font_glyph_from_string (int,int,int,int);
void hb_font_glyph_to_string (int,int,int,int);
int hb_font_is_immutable (int);
void hb_font_make_immutable (int);
int hb_font_reference (int);
void hb_font_set_face (int,int);
void hb_font_set_funcs (int,int,int,int);
void hb_font_set_funcs_data (int,int,int);
void hb_font_set_parent (int,int);
void hb_font_set_ppem (int,int,int);
void hb_font_set_ptem (int,float);
void hb_font_set_scale (int,int,int);
void hb_font_set_var_coords_design (int,int,int);
void hb_font_set_var_coords_normalized (int,int,int);
void hb_font_set_var_named_instance (int,int);
void hb_font_set_variations (int,int,int);
void hb_font_subtract_glyph_origin_for_direction (int,int,int,int,int);
int hb_glyph_info_get_glyph_flags (int);
int hb_language_from_string (int,int);
int hb_language_get_default ();
int hb_language_to_string (int);
int hb_map_allocation_successful (int);
void hb_map_clear (int);
int hb_map_create ();
void hb_map_del (int,int);
void hb_map_destroy (int);
int hb_map_get (int,int);
int hb_map_get_empty ();
int hb_map_get_population (int);
int hb_map_has (int,int);
int hb_map_is_empty (int);
int hb_map_reference (int);
void hb_map_set (int,int,int);
int hb_ot_color_glyph_get_layers (int,int,int,int,int);
int hb_ot_color_glyph_reference_png (int,int);
int hb_ot_color_glyph_reference_svg (int,int);
int hb_ot_color_has_layers (int);
int hb_ot_color_has_palettes (int);
int hb_ot_color_has_png (int);
int hb_ot_color_has_svg (int);
int hb_ot_color_palette_color_get_name_id (int,int);
int hb_ot_color_palette_get_colors (int,int,int,int,int);
int hb_ot_color_palette_get_count (int);
int hb_ot_color_palette_get_flags (int,int);
int hb_ot_color_palette_get_name_id (int,int);
void hb_ot_font_set_funcs (int);
void hb_ot_layout_collect_features (int,int,int,int,int,int);
void hb_ot_layout_collect_lookups (int,int,int,int,int,int);
int hb_ot_layout_feature_get_characters (int,int,int,int,int,int);
int hb_ot_layout_feature_get_lookups (int,int,int,int,int,int);
int hb_ot_layout_feature_get_name_ids (int,int,int,int,int,int,int,int);
int hb_ot_layout_feature_with_variations_get_lookups (int,int,int,int,int,int,int);
int hb_ot_layout_get_attach_points (int,int,int,int,int);
int hb_ot_layout_get_baseline (int,int,int,int,int,int);
int hb_ot_layout_get_glyph_class (int,int);
void hb_ot_layout_get_glyphs_in_class (int,int,int);
int hb_ot_layout_get_ligature_carets (int,int,int,int,int,int);
int hb_ot_layout_get_size_params (int,int,int,int,int,int);
int hb_ot_layout_has_glyph_classes (int);
int hb_ot_layout_has_positioning (int);
int hb_ot_layout_has_substitution (int);
int hb_ot_layout_language_find_feature (int,int,int,int,int,int);
int hb_ot_layout_language_get_feature_indexes (int,int,int,int,int,int,int);
int hb_ot_layout_language_get_feature_tags (int,int,int,int,int,int,int);
int hb_ot_layout_language_get_required_feature (int,int,int,int,int,int);
int hb_ot_layout_language_get_required_feature_index (int,int,int,int,int);
void hb_ot_layout_lookup_collect_glyphs (int,int,int,int,int,int,int);
int hb_ot_layout_lookup_get_glyph_alternates (int,int,int,int,int,int);
void hb_ot_layout_lookup_substitute_closure (int,int,int);
int hb_ot_layout_lookup_would_substitute (int,int,int,int,int);
void hb_ot_layout_lookups_substitute_closure (int,int,int);
int hb_ot_layout_script_get_language_tags (int,int,int,int,int,int);
int hb_ot_layout_script_select_language (int,int,int,int,int,int);
int hb_ot_layout_table_find_feature_variations (int,int,int,int,int);
int hb_ot_layout_table_find_script (int,int,int,int);
int hb_ot_layout_table_get_feature_tags (int,int,int,int,int);
int hb_ot_layout_table_get_lookup_count (int,int);
int hb_ot_layout_table_get_script_tags (int,int,int,int,int);
int hb_ot_layout_table_select_script (int,int,int,int,int,int);
int hb_ot_math_get_constant (int,int);
int hb_ot_math_get_glyph_assembly (int,int,int,int,int,int,int);
int hb_ot_math_get_glyph_italics_correction (int,int);
int hb_ot_math_get_glyph_kerning (int,int,int,int);
int hb_ot_math_get_glyph_top_accent_attachment (int,int);
int hb_ot_math_get_glyph_variants (int,int,int,int,int,int);
int hb_ot_math_get_min_connector_overlap (int,int);
int hb_ot_math_has_data (int);
int hb_ot_math_is_glyph_extended_shape (int,int);
int hb_ot_meta_get_entry_tags (int,int,int,int);
int hb_ot_meta_reference_entry (int,int);
int hb_ot_metrics_get_position (int,int,int);
float hb_ot_metrics_get_variation (int,int);
int hb_ot_metrics_get_x_variation (int,int);
int hb_ot_metrics_get_y_variation (int,int);
int hb_ot_name_get_utf16 (int,int,int,int,int);
int hb_ot_name_get_utf32 (int,int,int,int,int);
int hb_ot_name_get_utf8 (int,int,int,int,int);
int hb_ot_name_list_names (int,int);
void hb_ot_shape_glyphs_closure (int,int,int,int,int);
void hb_ot_shape_plan_collect_lookups (int,int,int);
int hb_ot_tag_to_language (int);
int hb_ot_tag_to_script (int);
void hb_ot_tags_from_script_and_language (int,int,int,int,int,int);
void hb_ot_tags_to_script_and_language (int,int,int,int);
int hb_script_from_iso15924_tag (int);
int hb_script_from_string (int,int);
int hb_script_get_horizontal_direction (int);
int hb_script_to_iso15924_tag (int);
void hb_set_add (int,int);
void hb_set_add_range (int,int,int);
int hb_set_allocation_successful (int);
void hb_set_clear (int);
int hb_set_copy (int);
int hb_set_create ();
void hb_set_del (int,int);
void hb_set_del_range (int,int,int);
void hb_set_destroy (int);
int hb_set_get_empty ();
int hb_set_get_max (int);
int hb_set_get_min (int);
int hb_set_get_population (int);
int hb_set_has (int,int);
void hb_set_intersect (int,int);
int hb_set_is_empty (int);
int hb_set_is_equal (int,int);
int hb_set_is_subset (int,int);
int hb_set_next (int,int);
int hb_set_next_range (int,int,int);
int hb_set_previous (int,int);
int hb_set_previous_range (int,int,int);
int hb_set_reference (int);
void hb_set_set (int,int);
void hb_set_subtract (int,int);
void hb_set_symmetric_difference (int,int);
void hb_set_union (int,int);
void hb_shape (int,int,int,int);
int hb_shape_full (int,int,int,int,int);
int hb_shape_list_shapers ();
int hb_tag_from_string (int,int);
void hb_tag_to_string (int,int);
int hb_unicode_combining_class (int,int);
int hb_unicode_compose (int,int,int,int);
int hb_unicode_decompose (int,int,int,int);
int hb_unicode_funcs_create (int);
void hb_unicode_funcs_destroy (int);
int hb_unicode_funcs_get_default ();
int hb_unicode_funcs_get_empty ();
int hb_unicode_funcs_get_parent (int);
int hb_unicode_funcs_is_immutable (int);
void hb_unicode_funcs_make_immutable (int);
int hb_unicode_funcs_reference (int);
void hb_unicode_funcs_set_combining_class_func (int,int,int,int);
void hb_unicode_funcs_set_compose_func (int,int,int,int);
void hb_unicode_funcs_set_decompose_func (int,int,int,int);
void hb_unicode_funcs_set_general_category_func (int,int,int,int);
void hb_unicode_funcs_set_mirroring_func (int,int,int,int);
void hb_unicode_funcs_set_script_func (int,int,int,int);
int hb_unicode_general_category (int,int);
int hb_unicode_mirroring (int,int);
int hb_unicode_script (int,int);
int hb_variation_from_string (int,int,int);
void hb_variation_to_string (int,int,int);
void hb_version (int,int,int);
int hb_version_atleast (int,int,int);
int hb_version_string ();
int InterceptGLObject ();
...
{"InterceptGLObject", InterceptGLObject}, // Avalonia.Browser
...
static void *pinvoke_tables[] = { libHarfBuzzSharp_imports,libSkiaSharp_imports,libSystem_Native_imports,libSystem_IO_Compression_Native_imports,libSystem_Globalization_Native_imports,};
static char *pinvoke_names[] = { "libHarfBuzzSharp","libSkiaSharp","libSystem.Native","libSystem.IO.Compression.Native","libSystem.Globalization.Native",};
InterpFtnDesc wasm_native_to_interp_ftndescs[59];
...
int res;
((WasmInterpEntrySig_1)wasm_native_to_interp_ftndescs [1].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [1].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_3)wasm_native_to_interp_ftndescs [3].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [3].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_4)wasm_native_to_interp_ftndescs [4].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [4].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_5)wasm_native_to_interp_ftndescs [5].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, wasm_native_to_interp_ftndescs [5].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_6)wasm_native_to_interp_ftndescs [6].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [6].arg);
return res;
}
...
((WasmInterpEntrySig_8)wasm_native_to_interp_ftndescs [8].func) (&arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, wasm_native_to_interp_ftndescs [8].arg);
}
...
int res;
((WasmInterpEntrySig_9)wasm_native_to_interp_ftndescs [9].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [9].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_10)wasm_native_to_interp_ftndescs [10].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [10].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_11)wasm_native_to_interp_ftndescs [11].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [11].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_12)wasm_native_to_interp_ftndescs [12].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, wasm_native_to_interp_ftndescs [12].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_15)wasm_native_to_interp_ftndescs [15].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [15].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_18)wasm_native_to_interp_ftndescs [18].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [18].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_19)wasm_native_to_interp_ftndescs [19].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [19].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_20)wasm_native_to_interp_ftndescs [20].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [20].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_21) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_MicroCom_Runtime_MicroComVtblBase_QueryInterface (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_21)wasm_native_to_interp_ftndescs [21].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [21].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_22) (int*,int*,int*);
int wasm_native_to_interp_MicroCom_Runtime_MicroComVtblBase_AddRef (int arg0) { 
int res;
((WasmInterpEntrySig_22)wasm_native_to_interp_ftndescs [22].func) (&res, &arg0, wasm_native_to_interp_ftndescs [22].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_23) (int*,int*,int*);
int wasm_native_to_interp_MicroCom_Runtime_MicroComVtblBase_Release (int arg0) { 
int res;
((WasmInterpEntrySig_23)wasm_native_to_interp_ftndescs [23].func) (&res, &arg0, wasm_native_to_interp_ftndescs [23].arg);
return res;
}
...
((WasmInterpEntrySig_24)wasm_native_to_interp_ftndescs [24].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [24].arg);
}
...
((WasmInterpEntrySig_26)wasm_native_to_interp_ftndescs [26].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [26].arg);
}
typedef void  (*WasmInterpEntrySig_27) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageRasterReleaseDelegateProxyImplementation (int arg0,int arg1) { 
((WasmInterpEntrySig_27)wasm_native_to_interp_ftndescs [27].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [27].arg);
}
typedef void  (*WasmInterpEntrySig_28) (int*,int*);
void wasm_native_to_interp_SkiaSharp_DelegateProxies_SKImageTextureReleaseDelegateProxyImplementation (int arg0) { 
((WasmInterpEntrySig_28)wasm_native_to_interp_ftndescs [28].func) (&arg0, wasm_native_to_interp_ftndescs [28].arg);
}
...
typedef void  (*WasmInterpEntrySig_30) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_DelegateProxies_GRGlGetProcDelegateProxyImplementation (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_30)wasm_native_to_interp_ftndescs [30].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [30].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_31)wasm_native_to_interp_ftndescs [31].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [31].arg);
return res;
}
...
((WasmInterpEntrySig_32)wasm_native_to_interp_ftndescs [32].func) (&arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [32].arg);
}
typedef void  (*WasmInterpEntrySig_33) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_ReadInternal (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_33)wasm_native_to_interp_ftndescs [33].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [33].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_34) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_PeekInternal (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_34)wasm_native_to_interp_ftndescs [34].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [34].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_35)wasm_native_to_interp_ftndescs [35].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [35].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_36)wasm_native_to_interp_ftndescs [36].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [36].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_37)wasm_native_to_interp_ftndescs [37].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [37].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_38) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_RewindInternal (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_38)wasm_native_to_interp_ftndescs [38].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [38].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_39)wasm_native_to_interp_ftndescs [39].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [39].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_40) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_SeekInternal (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_40)wasm_native_to_interp_ftndescs [40].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [40].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_41) (int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_MoveInternal (int arg0,int arg1,int arg2) { 
int res;
((WasmInterpEntrySig_41)wasm_native_to_interp_ftndescs [41].func) (&res, &arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [41].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_42)wasm_native_to_interp_ftndescs [42].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [42].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_43)wasm_native_to_interp_ftndescs [43].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [43].arg);
return res;
}
...
int res;
((WasmInterpEntrySig_44)wasm_native_to_interp_ftndescs [44].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [44].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_45) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_SKAbstractManagedStream_DestroyInternal (int arg0,int arg1) { 
((WasmInterpEntrySig_45)wasm_native_to_interp_ftndescs [45].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [45].arg);
}
typedef void  (*WasmInterpEntrySig_46) (int*,int*,int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedWStream_WriteInternal (int arg0,int arg1,int arg2,int arg3) { 
int res;
((WasmInterpEntrySig_46)wasm_native_to_interp_ftndescs [46].func) (&res, &arg0, &arg1, &arg2, &arg3, wasm_native_to_interp_ftndescs [46].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_47) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_SKAbstractManagedWStream_FlushInternal (int arg0,int arg1) { 
((WasmInterpEntrySig_47)wasm_native_to_interp_ftndescs [47].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [47].arg);
}
typedef void  (*WasmInterpEntrySig_48) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKAbstractManagedWStream_BytesWrittenInternal (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_48)wasm_native_to_interp_ftndescs [48].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [48].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_49) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_SKAbstractManagedWStream_DestroyInternal (int arg0,int arg1) { 
((WasmInterpEntrySig_49)wasm_native_to_interp_ftndescs [49].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [49].arg);
}
...
((WasmInterpEntrySig_50)wasm_native_to_interp_ftndescs [50].func) (&arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [50].arg);
}
...
((WasmInterpEntrySig_51)wasm_native_to_interp_ftndescs [51].func) (&arg0, &arg1, &arg2, wasm_native_to_interp_ftndescs [51].arg);
}
typedef void  (*WasmInterpEntrySig_52) (int*,int*,int*,int*);
int wasm_native_to_interp_SkiaSharp_SKDrawable_NewPictureSnapshotInternal (int arg0,int arg1) { 
int res;
((WasmInterpEntrySig_52)wasm_native_to_interp_ftndescs [52].func) (&res, &arg0, &arg1, wasm_native_to_interp_ftndescs [52].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_53) (int*,int*,int*);
void wasm_native_to_interp_SkiaSharp_SKDrawable_DestroyInternal (int arg0,int arg1) { 
((WasmInterpEntrySig_53)wasm_native_to_interp_ftndescs [53].func) (&arg0, &arg1, wasm_native_to_interp_ftndescs [53].arg);
}
typedef void  (*WasmInterpEntrySig_54) (int*,int*,int*,int*,int*,int*,int*);
...
((WasmInterpEntrySig_54)wasm_native_to_interp_ftndescs [54].func) (&arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [54].arg);
}
typedef void  (*WasmInterpEntrySig_55) (int*,int*,int*,int*,int*,int*);
...
((WasmInterpEntrySig_55)wasm_native_to_interp_ftndescs [55].func) (&arg0, &arg1, &arg2, &arg3, &arg4, wasm_native_to_interp_ftndescs [55].arg);
}
typedef void  (*WasmInterpEntrySig_56) (int*,int*,int*,int*,int*,int*,int*,int*);
...
int res;
((WasmInterpEntrySig_56)wasm_native_to_interp_ftndescs [56].func) (&res, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, wasm_native_to_interp_ftndescs [56].arg);
return res;
}
typedef void  (*WasmInterpEntrySig_57) (int*,int*,int*,int*,int*,int*,int*,int*);
...
"MicroCom_Runtime_MicroComVtblBase_QueryInterface",
"MicroCom_Runtime_MicroComVtblBase_AddRef",
"MicroCom_Runtime_MicroComVtblBase_Release",
